      ...
      <div class="flex items-center justify-between h-20">
        ...
        <nav class="hidden md:flex md:grow">
          ...
          <ul class="flex grow flex-wrap items-center font-medium">
            ...
            <li>
              <router-link to="/" class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out">About</router-link>
            </li>
            <li>
              <router-link to="/gallery" class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out">Gallery</router-link>
            </li>
            <li>
              <router-link to="/explore" class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out">Explore</router-link>
            </li>
            <!-- <li>
              <router-link to="/myEcosystem" class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out">My Ecosystem</router-link>
            </li> -->
            <li>
              <router-link to="/press" class="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 px-5 py-2 flex items-center transition duration-150 ease-in-out">Press</router-link>
            </li>
            <!-- <li>
          ...
          <!-- <ul class="flex justify-end flex-wrap items-center">
            <li>
              <router-link to="/contact" class="btn-sm text-white bg-teal-500 hover:bg-teal-400 ml-6">Contact</router-link>
            </li>
          </ul> -->
          ...
          >
            <nav v-show="mobileNavOpen" id="mobile-nav" ref="mobileNav" class="fixed top-0 h-screen z-20 left-0 w-full max-w-sm -ml-16 overflow-scroll bg-white dark:bg-gray-900 shadow-lg no-scrollbar">
              <div class="py-6 pr-4 pl-20">
                ...
                <ul>
                  <li>
                    <router-link to="/" class="flex text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 py-2">About</router-link>
                  </li>
                  <li>
                    <router-link to="/gallery" class="flex text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 py-2">Gallery</router-link>
                  </li>
                  <li>
                    <router-link to="/explore" class="flex text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 py-2">Explore</router-link>
                  </li>
                  <!-- <li>
                    <router-link to="/myEcosystem" class="flex text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 py-2">My Ecosystem</router-link>
                  </li> -->
                  <li>
                    <router-link to="/press" class="flex text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 py-2">Press</router-link>
                  </li>
                  <!-- <li>
                    <router-link to="/contact" class="font-medium w-full inline-flex items-center justify-center border border-transparent px-4 py-2 my-2 rounded text-white bg-teal-500 hover:bg-teal-400 transition duration-150 ease-in-out">Contact</router-link>
                  </li> -->
                </ul>
              </div>
            </nav>

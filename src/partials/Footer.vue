    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-16 border-t border-gray-200 dark:border-gray-800 -mt-px">
        ...
        <div class="md:flex md:items-center md:justify-between">
          ...
          <ul class="flex mb-4 md:order-2 md:ml-4 md:mb-0">
            <li>
              <a class="flex justify-center items-center text-white bg-teal-500 dark:text-teal-500 dark:bg-gray-800 hover:underline hover:bg-teal-600 rounded-full transition duration-150 ease-in-out"
                href="https://twitter.com/janakalford" aria-label="Twitter">
            ...
            <li class="ml-4">
              <a class="flex justify-center items-center text-white bg-teal-500 dark:text-teal-500 dark:bg-gray-800 hover:underline hover:bg-teal-600 rounded-full transition duration-150 ease-in-out"
                href="https://www.linkedin.com/in/janak-alford/" aria-label="Linkedin">
                <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                  <path
          ...
          <!-- Copyrights note -->
          <div class="text-gray-600 dark:text-gray-400 text-sm mr-4">&copy; Janak Alford. All rights reserved.</div>
          <a href="mailto:info@intelligentdigitalecosystems.com">
            <div class="text-gray-600 dark:text-gray-400 text-sm mr-4">info@intelligentdigitalecosystems.com</div>
          </a>

...
document.onmousemove = function(e){
	...
	console.log("Year:"  + year);
			...
			//	camera.position.x = 1400;
				...
				scene.fog = new THREE.Fog( 0x092044, 2200, 3200 );
...
*/
				...
				//geometry2.addAttribute( 'linewidth', 5 );
			...
			var multiplier = .032;//2.5;
			var year = 498.1;;//99.499999;//22.2; //498.07;//499.17; //498.1
			var timeBreak;
...
z=z/segmentScale;
			...
			//	camera.position.z = camera.position.z - Math.sin((time-origTime)/1000000)*2;
                ...
                camera.position.z = 3000+Math.cos(time/4000)*400;//cursorX*3;
				time = Date.now() * 0.001;

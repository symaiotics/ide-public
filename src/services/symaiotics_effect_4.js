...
document.onmousemove = function(e){
	...
	console.log("Year:"  + year);
				...
				scene.fog = new THREE.Fog( 0x092044, 2000, 5600 );
...
*/
			...
			var multiplier = .064;//2.5;
			var year = 11.9; //498.07;//499.17; //498.1
			var timeBreak;
...
var z =    1;// Math.sin( t *    n*(Math.cos(i)*10)  - n2) //- n2;
...
/*
	...
	*/
    ...
    var x = 1;//Math.cos((i*thisTime^2)/100000000) * n*(Math.sin(i)*10)  - n2;
    var y = 1;// Math.sin((i*thisTime^2)/100000000 ) * n*(Math.cos(i)*10) - n2;
    var z = 1;// Math.sin((i*thisTime^2)/100000000) * n*(Math.sin(i)*10) - n2;
...
z=z/10;
			...
			//	mesh.rotation.z = time * 0.0225;
			//	mesh2.rotation.z = time * 0.0225;

...
$(document).ready(function() {
	...
	console.log("Year:"  + year);
			...
			//	scene.fog = new THREE.Fog( 0x092044, 200, 5700 );
...
z=z/40;
			...
			//	camera.position.z = camera.position.z - Math.sin((time-origTime)/1000000)*2;
				...
				mesh.rotation.x = time * 0.0125;
				mesh2.rotation.x = time * 0.0125;
				mesh.rotation.y = time * 0.0125;
				mesh2.rotation.y = time * 0.0125;
